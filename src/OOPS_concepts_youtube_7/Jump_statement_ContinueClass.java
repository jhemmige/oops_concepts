...
public class Jump_statement_ContinueClass {
...
//	in break, as soon as the condition is met, the code comes out of the loop.
	...
	for (int i=0; i<=10;i++) {
			...
			System.out.println("breakloop_outside" + i);
		}
	...
	public void continueloop() {
		...
		for (int i=0; i<=10; i++) {
			...
			System.out.println("continueloop" + i);
	...
	public static void main(String[] args) {
		...
		Jump_statement_ContinueClass bc= new Jump_statement_ContinueClass();
